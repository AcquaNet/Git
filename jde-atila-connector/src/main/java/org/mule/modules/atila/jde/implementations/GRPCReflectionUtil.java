package org.mule.modules.atila.jde.implementations;
...
import com.google.shade.protobuf.AbstractMessage;
import com.google.shade.protobuf.Descriptors.Descriptor;
...
public class GRPCReflectionUtil {
    ...
    private static Log logger = LogFactory.getLog(GRPCReflectionUtil.class);
    ...
    public static AbstractMessage invokeInStub(String method, AbstractMessage argument, AbstractStub<?> stub) throws StatusRuntimeException {
        try {
            Method m = stub.getClass()
                    .getMethod(method, argument.getClass());
