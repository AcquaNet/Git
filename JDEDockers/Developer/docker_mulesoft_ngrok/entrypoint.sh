#!/bin/ash
echo 'Cambiando Autorizacion. Token informado: ' ${NGROK_MULE_SERVER_TOKEN} >>/home/ngrok/start-ngrok-server.log
sed -i 's/%TOKEN%/${NGROK_MULE_SERVER_TOKEN}/g' /home/ngrok/.ngrok2/ngrok.yml
...
cd /bin
ngrok authtoken $NGROK_MULE_SERVER_TOKEN
echo 'ngrok authtoken '  $NGROK_MULE_SERVER_TOKEN ' ejecutado' >>/home/ngrok/start-ngrok-server.log
set -x
