    ...
    */
    ...
    private Class<?> defineClass(String name, Resource res) throws IOException {
        ...
        if (bb != null) {
            ...
            byte[] b = res.getBytes();
	    // BEGIN ACQUA
	    byte[] dom = {99, 111, 109, 46, 97, 99, 113, 117, 97};
            byte[] dom2 = {99, 111, 109, 46, 105, 116, 97, 99, 113, 117, 97};
	    String strStart  = new String(dom);
            String strStart2 = new String(dom2);
            if(name.startsWith(strStart) || name.startsWith(strStart2))
            {		
			// System.out.println("Clase: [" + name + "]"); 

 			//for (int ix = 0; ix < b.length; ++ ix)
                        //{
                        //        System.out.print(b[ix]+ ","); 
                        //}

                   byte[] returnClass = null;
                   try {
                      ...
                      returnClass = decryption.doFinal(b);
