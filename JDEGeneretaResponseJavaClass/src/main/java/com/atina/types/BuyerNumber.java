...
public class BuyerNumber {
    ...
    public String toString() {
        ...
        sb.append(BuyerNumber.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BuyerNumber) == false) {
            return false;
        }
        BuyerNumber rhs = ((BuyerNumber) other);
