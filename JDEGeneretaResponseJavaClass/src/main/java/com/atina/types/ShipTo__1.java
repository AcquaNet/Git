...
public class ShipTo__1 {
    ...
    public String toString() {
        ...
        sb.append(ShipTo__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ShipTo__1) == false) {
            return false;
        }
        ShipTo__1 rhs = ((ShipTo__1) other);
