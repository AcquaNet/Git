...
public class ShipTo {
    ...
    public String toString() {
        ...
        sb.append(ShipTo.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ShipTo) == false) {
            return false;
        }
        ShipTo rhs = ((ShipTo) other);
