...
public class Supplier__1 {
    ...
    public String toString() {
        ...
        sb.append(Supplier__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Supplier__1) == false) {
            return false;
        }
        Supplier__1 rhs = ((Supplier__1) other);
