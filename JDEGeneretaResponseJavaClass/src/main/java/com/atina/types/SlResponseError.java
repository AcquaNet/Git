...
public class SlResponseError {
    ...
    public String toString() {
        ...
        sb.append(SlResponseError.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("errors");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SlResponseError) == false) {
            return false;
        }
        SlResponseError rhs = ((SlResponseError) other);
