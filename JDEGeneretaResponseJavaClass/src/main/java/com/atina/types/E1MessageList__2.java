...
public class E1MessageList__2 {
    ...
    public String toString() {
        ...
        sb.append(E1MessageList__2 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof E1MessageList__2) == false) {
            return false;
        }
        E1MessageList__2 rhs = ((E1MessageList__2) other);
