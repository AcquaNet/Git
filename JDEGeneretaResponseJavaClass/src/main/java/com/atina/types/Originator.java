...
public class Originator {
    ...
    public String toString() {
        ...
        sb.append(Originator.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Originator) == false) {
            return false;
        }
        Originator rhs = ((Originator) other);
