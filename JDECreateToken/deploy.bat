...
mvn deploy:deploy-file -DgroupId=com.atina -DartifactId=JDECreateToken -Dversion=1.0.0 -DrepositoryId=acquanet-central -Dpackaging=jar -Dfile=target\JDECreateToken-1.0.0.jar -Durl=http://157.245.236.175:8081/artifactory/libs-release
ECHO ==========================================================
